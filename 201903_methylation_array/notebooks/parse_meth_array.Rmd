...
```{r}
sample_anno <- read_csv('../../201901_locate_discovery_data/annotations/Batch1through6_sample_attributes.csv.gz')
case_list <- read_lines('../../201901_locate_discovery_data/cptac3_gbm_discovery_samples.list')
```
