...
```{r}
meth_tbl <- read_feather('../processed_data/cptac3_gbm_epic_meth_array.batch1-9.feather')
```
...
meth_se <- SummarizedExperiment(
    ...
    metadata = list(
        cohort = 'CPTAC3 GBM adhoc cohort (batch 1 to 9)',
...
```{r}
saveRDS(meth_se, '../processed_data/gbm_dna_meth.batch1-9.rds')
```
